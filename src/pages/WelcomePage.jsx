...
// 			btn.textContent = "STEP INSIDE";
// 		});
// 	}, []);

// 	return (
// 		<section className="home-container">
// 			<section id="enter" ref={enterSectionRef}></section>
// 			<section id="welcome" ref={welcomeSectionRef}>
// 				<h2>welcome to the</h2>
// 				<h1>CircuS</h1>
// 				<section id="enter-btn" ref={btnRef} className="button-container">
// 					<div className="button-background"></div>
// 					<span className="button-text">
// 						<Link to="/events">STEP INSIDE</Link>
// 					</span>
// 				</section>
// 			</section>
// 		</section>
